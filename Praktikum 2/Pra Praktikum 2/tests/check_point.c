...
START_TEST(CreatePOINT_TC1) {
/* Mengecek CreatePOINT berhasil membentuk sebuah POINT */
  POINT P;
...
Suite *point_suite(void) { 
  ...
  tcase_add_test(tc_make, CreatePOINT_TC1);
